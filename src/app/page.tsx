  ...
  return (
    <section id="projects" className="py-24 px-6 bg-zinc-50 dark:bg-zinc-900/50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
          <div className="relative w-full aspect-video">
            <Image
              src="/FeaturedProject.png"
              alt="Christmas Tree Decorator 2025"
              fill
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="text-xs px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full">Next.js</span>
              <span className="text-xs px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full">React</span>
              <span className="text-xs px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full">dnd-kit</span>
            </div>
          ...
          <div className="flex gap-4 mt-8">
            <a
              href="https://xmas-tree-decorator2025.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-500 text-white rounded-full font-medium hover:scale-105 transition-transform"
            >
              Live Demo
            </a>
            <a
              href="https://github.com/sycherry/xmas-tree-decorator2025"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 border border-zinc-300 dark:border-zinc-700 rounded-full font-medium hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
            >
